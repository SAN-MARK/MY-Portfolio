...
export const CoursesSection: React.FC = () => {
  ...
  const categories: CourseCategory[] = [
    {
      ...
      name: "AI & Automation",
      accent: "#E31E24",
      badgeBg: "bg-[#E31E24]/15",
      badgeBorder: "border-[#000000]",
      badgeText: "text-[#E31E24]",
      icon: "smart_toy",
      courses: [
        {
          id: "c1",
  ...
  return (
    <section id="courses" className="py-24 relative bg-[#0d0d0d] overflow-hidden">
      ...
      <div className="absolute top-1/3 -left-40 w-96 h-96 bg-[#E31E24]/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16 space-y-4">
          ...
          <h2 className="text-4xl sm:text-6xl font-display font-black text-[#F5F5F0] tracking-wider uppercase">
            COURSES & <span className="text-[#E31E24]">CERTIFICATIONS</span>
          </h2>

          <p className="text-sm sm:text-base font-sans text-[#B8B8B0] max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="flex items-center justify-center flex-wrap gap-2 sm:gap-3 mb-12">
          <button
            ...
            className={`px-4 py-2 rounded-xl text-xs font-mono font-bold transition-all border-2 border-[#000000] cursor-pointer ${
              activeCategory === 'ALL'
                ? 'bg-[#E31E24] text-[#F5F5F0] shadow-[3px_3px_0px_#000000]'
          ...
          {categories.map((cat) => (
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-mono font-bold transition-all border-2 border-[#000000] cursor-pointer flex items-center gap-2 ${
          ...
          {categories
            ...
            .map((cat) => (
              <div key={cat.id} className="space-y-6">
                ...
                <div className="flex items-center justify-between pl-4 py-2.5 border-l-4 border-[#E31E24] rounded-r-xl bg-[#161616] border-2 border-r-2 border-t-2 border-b-2 border-[#000000] shadow-[3px_3px_0px_#000000]">
                  <div className="flex items-center gap-3">
                    <span className="material-symbols-outlined text-xl text-[#E31E24]">
                      {cat.icon}
                    </span>
                    <h3 className="font-display font-bold text-2xl text-[#F5F5F0] tracking-wider uppercase">
                      {cat.name}
                    </h3>
                  </div>

                  <span className="font-mono text-xs text-[#B8B8B0] font-bold pr-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {cat.courses.map((course) => (
                    <a
                      ...
                      className="bg-[#161616] border-3 border-[#000000] shadow-[4px_4px_0px_#000000] hover:border-[#E31E24] hover:shadow-[6px_6px_0px_#E31E24] rounded-[14px] p-6 flex flex-col justify-between transition-all duration-300 hover:-translate-y-1 group cursor-pointer"
                    >
                      <div className="space-y-4">
                        
                        {/* Top Badge & Code */}
                        <div className="flex items-center justify-between gap-2 flex-wrap">
                          <span className="px-2.5 py-0.5 rounded-full border-2 border-[#000000] text-[10px] font-mono font-bold tracking-wider uppercase bg-[#E31E24]/15 text-[#E31E24]">
                            {course.badge || 'VERIFIED'}
                          </span>

                          {course.certCode && (
                            <span className="font-mono text-[10px] text-[#F5F5F0] bg-[#0d0d0d] px-2 py-0.5 rounded border-2 border-[#000000] font-bold">
                              {course.certCode}
                            </span>
                          )}
                        </div>
                        ...
                        {/* Title & Issuer */}
                        <div>
                          <h4 className="font-headline font-bold text-base text-[#F5F5F0] group-hover:text-[#E31E24] transition-colors leading-snug">
                            {course.title}
                          </h4>
                          <p className="font-mono text-xs text-[#B8B8B0] mt-1.5 flex items-center gap-1.5">
                            <span className="material-symbols-outlined text-sm text-[#E31E24]">domain</span>
                            {course.issuer}
                          </p>
                        </div>
                      ...
                      <div className="pt-4 mt-6 border-t-2 border-[#000000] flex items-center justify-between text-[11px] font-mono text-[#B8B8B0]">
                        <span className="flex items-center gap-1">
                          <span className="material-symbols-outlined text-xs text-[#E31E24]">calendar_today</span>
                          Issued: {course.date}
                        </span>

                        <span className="text-[#E31E24] group-hover:text-[#F5F5F0] flex items-center gap-1 font-bold transition-colors">
                          <span>VERIFY</span>
